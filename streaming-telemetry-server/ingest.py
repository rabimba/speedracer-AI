...
# Pure NMEA parsing lives in a dependency-light module so it can be unit tested
# without the server/transport stack (FastAPI, sse-starlette, pyserial-asyncio).
